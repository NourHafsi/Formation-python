...
print(l.count('ahmed')) """
#exercice6 de TD2: Trier une liste de nombres dans l’ordre croissant.probleme 
""" L=[4,1,3]
print(L)
i=0
for i:
 if L[i]>L[i+1]:
   ...
   print(L) """
#exercice7 de TD2: Inverser une liste.
# Liste initiale
...
#exercice20 de TD2: Calculer la réduction selon l’âge (ex : -50% si <12 ans): probleme
""" age=int(input("donner l'age\n"))
prixi=float(input("donner le prix"))
...
""" i=0 #peut l'utiliser ou non ?????
while i in range(11):
    print (i)
    i+=1 """

#exercice30 de TD2: Calculer la factorielle d’un nombre avec une boucle.:j'ai un probleme comment je peux sommer le factoriel
""" n= int(input("donner un nombre\n"))
for i in range(n):
    f=(n-(n-i))*n
print(f)
